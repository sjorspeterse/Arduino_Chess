...
byte magnetlow = 30;
unsigned int delaytime = 5000; // number of milliseconds to wait after first part of voice contol has been said
...
void loop()
{
	if ((j == 2 || flow == 3 || type == 10 || promote == 1) && millis() > (counter + 5000)) {
		j = 0;
		type = 0;
		feedbacklight(1,0);
		flow = 0;
...
void serialEvent() // when something has been typed in
{
